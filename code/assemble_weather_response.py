#!/usr/bin/env python3
"""Combine place pick + forecast JSON; verify grid coords vs geocode and print payload."""
...
def main() -> None:
    ...
    q = f"latitude={lat}&longitude={lon}&current_weather=true"
    ...
    out = {
        "reference": {
            ...
            "request_url": place.get("geocode_request_url", ""),
